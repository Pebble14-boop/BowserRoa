...
add_sprites("airdodge","crouch","dash","dashstart","dashstop","dashturn","doublejump",
            "idle","intro","jump","jumpstart","land","landinglag","pratfall","parry",
...
add_sprites("bair","dair","dattack","dspecial","dstrong","dtilt","fair","fspecial","fstrong",
            "ftilt","jab","nair","nspecial","taunt","taunt_forward","taunt_down", "uair","uspecial","uspecial_grounded","ustrong"
            ,"utilt","nspecial_proj_small","nspecial_proj_big", "nspecial_air",);

//=================OTHER=================
//  hurt sprites
add_sprites("hurt","bighurt", );
...
if (get_player_color(player) == 15) set_skin("dry");
