...
set_window_value(AT_DATTACK, 2, AG_WINDOW_HSPEED, 10.5);
...
set_hitbox_value(AT_DATTACK, 2, HG_WIDTH, 107);
...
set_hitbox_value(AT_DATTACK, 3, HG_HITBOX_X, 21);
set_hitbox_value(AT_DATTACK, 3, HG_HITBOX_Y, -13);
set_hitbox_value(AT_DATTACK, 3, HG_HITBOX_GROUP, 1);
set_hitbox_value(AT_DATTACK, 3, HG_WIDTH, 137);
set_hitbox_value(AT_DATTACK, 3, HG_HEIGHT, 49);
...
set_hitbox_value(AT_DATTACK, 3, HG_HITPAUSE_SCALING, .2);
