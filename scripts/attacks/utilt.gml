...
set_window_value(AT_UTILT, 1, AG_WINDOW_SFX, sound_get("swipe"));
...
set_hitbox_value(AT_UTILT, 2, HG_HITBOX_Y, -89);
...
set_hitbox_value(AT_UTILT, 3, HG_HITBOX_X, -63);
set_hitbox_value(AT_UTILT, 3, HG_WIDTH, 41);
