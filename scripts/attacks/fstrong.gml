...
set_window_value(AT_FSTRONG, 1, AG_WINDOW_SFX, sound_get("bowser_HU"));
//release
set_window_value(AT_FSTRONG, 2, AG_WINDOW_LENGTH, 11);
set_window_value(AT_FSTRONG, 2, AG_WINDOW_ANIM_FRAMES, 2);
set_window_value(AT_FSTRONG, 2, AG_WINDOW_ANIM_FRAME_START, 3);
set_window_value(AT_FSTRONG, 2, AG_WINDOW_HAS_SFX, 1);
set_window_value(AT_FSTRONG, 2, AG_WINDOW_SFX, asset_get("sfx_bird_downspecial"));
...
set_hitbox_value(AT_FSTRONG, 1, HG_HITBOX_X, 51);
