...
set_window_value(AT_DSPECIAL_AIR, 1, AG_WINDOW_HAS_CUSTOM_FRICTION, 2);
set_window_value(AT_DSPECIAL_AIR, 1, AG_WINDOW_CUSTOM_AIR_FRICTION, 1);
...
set_window_value(AT_DSPECIAL_AIR, 2,AG_WINDOW_VSPEED, 19.5);
set_window_value(AT_DSPECIAL_AIR, 2, AG_WINDOW_HAS_CUSTOM_FRICTION, 2);
set_window_value(AT_DSPECIAL_AIR, 2, AG_WINDOW_CUSTOM_AIR_FRICTION, 1);


//bowser slam
set_window_value(AT_DSPECIAL_AIR, 3, AG_WINDOW_LENGTH, 200);
...
set_window_value(AT_DSPECIAL_AIR, 3, AG_WINDOW_VSPEED, 18);
set_window_value(AT_DSPECIAL_AIR, 3, AG_WINDOW_HAS_CUSTOM_FRICTION, 1);
set_window_value(AT_DSPECIAL_AIR, 3, AG_WINDOW_CUSTOM_AIR_FRICTION, 1);

//bowser hitting the floor
set_window_value(AT_DSPECIAL_AIR, 4, AG_WINDOW_LENGTH, 32);
...
set_window_value(AT_DSPECIAL_AIR, 4, AG_WINDOW_VSPEED_TYPE, 10);
set_window_value(AT_DSPECIAL_AIR, 4, AG_WINDOW_VSPEED, 1);
...
set_hitbox_value(AT_DSPECIAL_AIR, 3, HG_LIFETIME, 30);
...
set_hitbox_value(AT_DSPECIAL_AIR, 4, HG_WINDOW, 1);
set_hitbox_value(AT_DSPECIAL_AIR, 4, HG_WINDOW_CREATION_FRAME, 1);
set_hitbox_value(AT_DSPECIAL_AIR, 4, HG_LIFETIME, 11);
set_hitbox_value(AT_DSPECIAL_AIR, 4, HG_HITBOX_Y, -29);
set_hitbox_value(AT_DSPECIAL_AIR, 4, HG_HITBOX_X, 23);
set_hitbox_value(AT_DSPECIAL_AIR, 4, HG_WIDTH, 80);
set_hitbox_value(AT_DSPECIAL_AIR, 4, HG_HEIGHT, 80);
set_hitbox_value(AT_DSPECIAL_AIR, 4, HG_PRIORITY, 1);
set_hitbox_value(AT_DSPECIAL_AIR, 4, HG_DAMAGE, 7);
...
set_hitbox_value(AT_DSPECIAL_AIR, 4, HG_VISUAL_EFFECT, 20);
...
set_attack_value(AT_DSPECIAL_AIR, AG_MUNO_ATTACK_MISC_ADD, "Jump cancel starting on frame " + string(get_window_value(AT_DSPECIAL_AIR, 1, AG_WINDOW_LENGTH) + 1) + " unless parried.");
